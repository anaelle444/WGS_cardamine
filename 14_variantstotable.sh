...
output=/scratch/ajj7988/results/85_samples/step14_jointcall/tables/chr${i}_joint_H5LGVDRX5_WGS_C_hirsuta.table 

gatk VariantsToTable \
     -V $input \
     -F CHROM -F QUAL -F QD -F SOR -F MQ -F MQRankSum -F ReadPosRankSum -F ALT -F DP -F POS -F TYPE -F TRANSITION -F HET \
