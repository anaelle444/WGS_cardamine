...
#SBATCH --job-name=cond3filtering
#SBATCH --error=/scratch/ajj7988/log/week4/85samples/verification/condition3/filter_p2_%A.err
#SBATCH --output=/scratch/ajj7988/log/week4/85samples/verification/condition3/filter_p2_%A.out
#SBATCH --array=1-8
