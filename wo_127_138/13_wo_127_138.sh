...
#SBATCH --output=/scratch/ajj7988/log/week6/DBImport/13DB_chr_%j_%a.out
#SBATCH --array=1-8
...
samplemap=/scratch/ajj7988/results/85_samples/wo_127_138/samplemap
outdir=/scratch/ajj7988/results/85_samples/wo_127_138/DBImport
